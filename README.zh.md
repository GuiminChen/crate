...
设计理念来自把 LLM 当作对自己材料的**编译器**，而非一次性聊天接口。（参见 [Andrej Karpathy 关于 LLM 知识库的帖文](https://x.com/karpathy/status/2039805659525644595)。）与该工作流的**逐项对照**见 [docs/usage.md §7.5 Karpathy 式对照](docs/usage.md#karpathy-style-comparison)。
